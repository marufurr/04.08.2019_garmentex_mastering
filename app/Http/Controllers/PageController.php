...
class PageController extends FrontController
{
	...
	public function contactPost(ContactRequest $request)
	{
		...
		public function about_us(){
			return view('layouts.footer_partials.about_us');
		}

		public function terms(){
			return view('layouts.footer_partials.terms_and_conditions');
		}

		public function directory(){
			return view('layouts.directory.directory');
		}


		public function home_page(){
			return view('layouts.directory.pages.home');
		}

		public function contact_us(){
			return view('layouts.directory.pages.contact_us');
		}

		public function about(){
			return view('layouts.directory.pages.about_us');
		}
}
