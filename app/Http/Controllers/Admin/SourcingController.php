...
use App\Http\Requests\Admin\SourcingRequest as StoreRequest;
use App\Http\Requests\Admin\SourcingRequest as UpdateRequest;

class SourcingController extends PanelController
{
	...
	public function setup()
	{
		...
		*/
		...
		$this->xPanel->addField([
			'label'             => trans("admin::messages.Sourcing Type"),
			'name'              => 'sourcing_type_id',
			'type'              => 'select2_from_array',
			'options'           => $this->sourcingType(),
			'allows_null'       => false,
			'wrapperAttributes' => [
				'class' => 'form-group col-md-6',
			],
