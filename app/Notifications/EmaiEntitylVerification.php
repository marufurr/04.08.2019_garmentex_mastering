...
class EmaiEntitylVerification extends Notification implements ShouldQueue
{
	use Queueable;
	...
	{
		$verificationUrl = lurl('register/verify/user/email/' . $this->entity->email_token);
		...
		return (new MailMessage)
			...
			->action($this->entity->email_token, "")
