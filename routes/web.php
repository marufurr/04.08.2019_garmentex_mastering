...
Route::group([
	...
	Route::group(['middleware' => ['web', 'install.checker']], function ($router) {
		...
		Route::group(['middleware' => ['guest', 'prevent.back.history']], function ($router) {
		    ...
		    Route::get('register/{path?}', 'Auth\RegisterController@showRegistrationForm')->where('path', '.+');
		...
		Route::post('verify/user/checkactivation', 'Auth\RegisterController@checkActivationCode');
		Route::post('verify/user/sendVerificationCode', 'Auth\RegisterController@sendVerificationCode');
		Route::post('verify/user/token', 'Auth\RegisterController@verifyEntityToken');
		...
		Route::get(LaravelLocalization::transRoute('routes.page'), 'PageController@index');
		 ...
		 Route::get("terms-condition", 'PageController@terms')->name('terms_condition');

		 // directory
		 Route::get("directory", 'PageController@directory')->name('directory');
		 Route::get("directory/home-page", 'PageController@home_page')->name('home-page');
		 Route::get("directory/contact-us", 'PageController@contact_us')->name('contact-us');
		 Route::get("directory/about-us", 'PageController@about')->name('about-page');
