 <div class="trade_services mt-3">
                    <h4 class="font_bold clr_black mb-4 text-uppercase">Events</h4>
                    <div class="row">
                        <div class="col-xl-6">
                            <a href="#" class="trade_services_item d-block border_1">
                                <div class="trade_services_item_img">
                                    <img src="{{asset('assets/modules/images/smart_expo_1.jpg')}}" alt="img" class="w-100">
                                    <p class="text-white font_bold">
                                        <i class="fa fa-users" aria-hidden="true"></i> 3000+ Supliers
                                    </p>
                        ...
                        <div class="col-xl-6">
                            <a href="#" class="trade_services_item d-block border_1">
                                <div class="trade_services_item_img">
                                    <img src="{{asset('assets/modules/images/smart_expo_2.jpg')}}" alt="img" class="w-100">
                                    <p class="text-white font_bold">
                                        <i class="fa fa-users" aria-hidden="true"></i> 3000+ Supliers
                                    </p>
                                    <span class="opening text-white">Opening</span>
